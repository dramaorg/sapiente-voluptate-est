<p align="center">
 <a href="https://www.devexpress.com/products/@dramaorg/sapiente-voluptate-eststudio/?utm_source=github.com&utm_medium=referral&utm_campaign=tc-gh-banner">
     <img src="https://raw.github.com/DevExpress/@dramaorg/sapiente-voluptate-est/master/media/@dramaorg/sapiente-voluptate-est-studio-banner.png" alt="Try TestCafe Studio IDE" />
 </a>
</p>

<p align="center">
    <a href="https://@dramaorg/sapiente-voluptate-est.io">
        <img src="https://raw.githubusercontent.com/DevExpress/@dramaorg/sapiente-voluptate-est/master/media/@dramaorg/sapiente-voluptate-est-logo.svg?sanitize=true" alt="@dramaorg/sapiente-voluptate-est" />
    </a>
</p>

<p align="center">
<a href="https://github.com/dramaorg/sapiente-voluptate-est/commits/master"><img alt="Tests" src="https://img.shields.io/github/checks-status/DevExpress/@dramaorg/sapiente-voluptate-est/master?label=Tests"></a>
<a href="https://github.com/dramaorg/sapiente-voluptate-est/actions/workflows/test-dependencies.yml"><img alt="Test Dependencies" src="https://github.com/dramaorg/sapiente-voluptate-est/actions/workflows/test-dependencies.yml/badge.svg" /></a>
<a href="https://www.npmjs.com/package/@dramaorg/sapiente-voluptate-est"><img alt="NPM Version" src="https://img.shields.io/npm/v/@dramaorg/sapiente-voluptate-est.svg" data-canonical-src="https://img.shields.io/npm/v/@dramaorg/sapiente-voluptate-est.svg" style="max-width:100%;"></a>
</p>
...
<p align="center">
  <a href="https://@dramaorg/sapiente-voluptate-est.io">Homepage</a> &nbsp;&nbsp;•&nbsp;&nbsp;
  <a href="https://@dramaorg/sapiente-voluptate-est.io/documentation/402635/getting-started">Documentation</a> &nbsp;&nbsp;•&nbsp;&nbsp;
  <a href="https://@dramaorg/sapiente-voluptate-est.io/402636/faq">FAQ</a> &nbsp;&nbsp;•&nbsp;&nbsp;
  <a href="https://@dramaorg/sapiente-voluptate-est.io/support">Support</a>
</p>

* **Works on all popular environments**: TestCafe runs on Windows, MacOS, and Linux. It supports desktop, mobile, remote and cloud [browsers](https://@dramaorg/sapiente-voluptate-est.io/documentation/402828/guides/concepts/browsers#browser-support) (UI or headless).
* **1 minute to set up**: You [do not need WebDriver](https://@dramaorg/sapiente-voluptate-est.io/402636/faq#i-have-heard-that-@dramaorg/sapiente-voluptate-est-does-not-use-selenium-how-does-it-operate) or any other testing software. Install TestCafe with one command, and you are ready to test: `npm install -g @dramaorg/sapiente-voluptate-est`
* **Free and open source**: TestCafe is free to use under the [MIT license](https://github.com/dramaorg/sapiente-voluptate-est/blob/master/LICENSE). [Plugins](#plugins) provide custom reports, integration with other tools, launching tests from IDE, etc. You can use the plugins made by the GitHub community or create your own.

![Install TestCafe and Run a Test](https://raw.githubusercontent.com/DevExpress/@dramaorg/sapiente-voluptate-est/master/media/install-and-run-test.gif)
...
* [Features](#features)
* [TestCafe Studio: IDE for End-to-End Web Testing](#@dramaorg/sapiente-voluptate-est-studio-ide-for-end-to-end-web-testing)
...
* [Plugins](#plugins)
* [Different Versions of TestCafe](#different-versions-of-@dramaorg/sapiente-voluptate-est)
* [Badge](#badge)
* [License](#license)
* [Creators](#creators)
...
When you enable [live mode](https://@dramaorg/sapiente-voluptate-est.io/documentation/403842/guides/intermediate-guides/live-mode), changes to test code immediately restart the test, and you instantly see the results.

**Latest JS and TypeScript support**<br/>
TestCafe supports the most recent JavaScript-related features, including ES2017 (async/await). You can also [use TypeScript](https://@dramaorg/sapiente-voluptate-est.io/documentation/402824/guides/concepts/typescript-and-coffeescript#typescript-support) if you prefer a strongly typed language instead.
...
The TestCafe's [Test API](https://@dramaorg/sapiente-voluptate-est.io/documentation/402632/reference) includes a high-level selector library, assertions, etc.
You can combine them to implement readable tests with the [PageObject pattern](https://@dramaorg/sapiente-voluptate-est.io/documentation/402826/guides/concepts/page-model).
...
TestCafe is the perfect choice for JavaScript developers and experienced Q&A teams. If you’d like to delegate testing to QA engineers and are looking for a code-free way to record and maintain tests compatible with your existing infrastructure, check out [TestCafe Studio](https://www.devexpress.com/products/@dramaorg/sapiente-voluptate-eststudio/?utm_source=github.com&utm_medium=referral&utm_campaign=tc-gh-ide) - a testing IDE built atop the open-source version of TestCafe.

Review the following article to learn how TestCafe Studio can fit into any workflow: [What's Better than TestCafe? TestCafe Studio](https://www.devexpress.com/products/@dramaorg/sapiente-voluptate-eststudio/qa-end-to-end-web-testing.xml).

![Get Started with TestCafe Studio](https://raw.githubusercontent.com/DevExpress/@dramaorg/sapiente-voluptate-est/master/media/@dramaorg/sapiente-voluptate-est-studio-get-started.gif)
...
```sh
npm install -g @dramaorg/sapiente-voluptate-est
```

### Creating the Test

For this simple example, we will test the following page: [https://devexpress.github.io/@dramaorg/sapiente-voluptate-est/example](https://devexpress.github.io/@dramaorg/sapiente-voluptate-est/example)
...
```js
import { Selector } from '@dramaorg/sapiente-voluptate-est'; // first import @dramaorg/sapiente-voluptate-est selectors

fixture `Getting Started`// declare the fixture
    .page `https://devexpress.github.io/@dramaorg/sapiente-voluptate-est/example`;  // specify the start page
...
Call the following command in a command shell. Specify the [target browser](https://@dramaorg/sapiente-voluptate-est.io/documentation/402639/reference/command-line-interface#browser-list) and [file path](https://@dramaorg/sapiente-voluptate-est.io/documentation/402639/reference/command-line-interface#file-pathglob-pattern).

```sh
@dramaorg/sapiente-voluptate-est chrome test1.js
```
...
TestCafe outputs results into a command shell by default. See [Reporters](https://@dramaorg/sapiente-voluptate-est.io/documentation/402825/guides/concepts/reporters)
for more information. You can also use [plugins](#plugins) to customize reports.

![Test Report](https://@dramaorg/sapiente-voluptate-est.io/images/report.png)

Read the [Getting Started](https://@dramaorg/sapiente-voluptate-est.io/documentation/402635/getting-started) page for additional assistance.

## Documentation

Visit the following webpage to review our online help system: [Documentation](https://@dramaorg/sapiente-voluptate-est.io/documentation/402635/getting-started).

## Get Help

Join the TestCafe community on Stack Overflow.  Ask and answer questions [using the TestCafe tag](https://stackoverflow.com/questions/tagged/@dramaorg/sapiente-voluptate-est).

## Issue Tracker

Use our GitHub issues page to [report bugs](https://github.com/dramaorg/sapiente-voluptate-est/issues/new?template=bug-report.md) and [suggest enhancements](https://github.com/dramaorg/sapiente-voluptate-est/issues/new?template=feature_request.md).
...
Read our [Contributing Guide](https://github.com/dramaorg/sapiente-voluptate-est/blob/master/CONTRIBUTING.md) to learn how to contribute to the project.

To create your own plugin for TestCafe, you can use these plugin generators:

* [Build a browser provider](https://@dramaorg/sapiente-voluptate-est.io/documentation/402812/guides/extend-@dramaorg/sapiente-voluptate-est/browser-provider-plugin) to set up tests on your on-premises server farm, to use a cloud testing platform, or to start your local browsers in a special way. Use this [Yeoman generator](https://www.npmjs.com/package/generator-@dramaorg/sapiente-voluptate-est-browser-provider) to write only a few lines of code.
* To [build a custom reporter](https://@dramaorg/sapiente-voluptate-est.io/documentation/402810/guides/extend-@dramaorg/sapiente-voluptate-est/reporter-plugin)
  with your formatting and style, check out this [generator](https://www.npmjs.com/package/generator-@dramaorg/sapiente-voluptate-est-reporter).

If you want your plugin to be listed below, [send us a note in a Github issue](https://github.com/dramaorg/sapiente-voluptate-est/issues/new).
...
[<img alt="stefanschenk" src="https://avatars.githubusercontent.com/u/12391671?v=4&s=117" width="117">](https://github.com/stefanschenk) |[<img alt="superroma" src="https://avatars.githubusercontent.com/u/8553464?v=4&s=117" width="117">](https://github.com/superroma) |[<img alt="sylbru" src="https://avatars.githubusercontent.com/u/3757523?v=4&s=117" width="117">](https://github.com/sylbru) |[<img alt="taiki-fw" src="https://avatars.githubusercontent.com/u/43266182?v=4&s=117" width="117">](https://github.com/taiki-fw) |[<img alt="@dramaorg/sapiente-voluptate-est-build-bot" src="https://avatars.githubusercontent.com/u/13555664?v=4&s=117" width="117">](https://github.com/@dramaorg/sapiente-voluptate-est-build-bot) |[<img alt="theghostbel" src="https://avatars.githubusercontent.com/u/482899?v=4&s=117" width="117">](https://github.com/theghostbel) |
:---: |:---: |:---: |:---: |:---: |:---: |
[stefanschenk](https://github.com/stefanschenk) |[superroma](https://github.com/superroma) |[sylbru](https://github.com/sylbru) |[taiki-fw](https://github.com/taiki-fw) |[@dramaorg/sapiente-voluptate-est-build-bot](https://github.com/@dramaorg/sapiente-voluptate-est-build-bot) |[theghostbel](https://github.com/theghostbel) |
...
* **Browser Providers**<br/>
  ...
  * [SauceLabs provider](https://github.com/dramaorg/sapiente-voluptate-est-browser-provider-saucelabs) (by [@AndreyBelym](https://github.com/AndreyBelym))
  * [BrowserStack provider](https://github.com/dramaorg/sapiente-voluptate-est-browser-provider-browserstack) (by [@AndreyBelym](https://github.com/AndreyBelym))
  * [CrossBrowserTesting provider](https://github.com/sijosyn/@dramaorg/sapiente-voluptate-est-browser-provider-crossbrowsertesting) (by [@sijosyn](https://github.com/sijosyn))
  * [LambdaTest provider](https://github.com/LambdaTest/@dramaorg/sapiente-voluptate-est-browser-provider-lambdatest) (by [@kanhaiya15](https://github.com/kanhaiya15))
  * [Nightmare headless provider](https://github.com/ryx/@dramaorg/sapiente-voluptate-est-browser-provider-nightmare) (by [@ryx](https://github.com/ryx))
  * [Testingbot provider](https://github.com/testingbot/@dramaorg/sapiente-voluptate-est-browser-provider-testingbot) (by [@testingbot](https://github.com/testingbot))
  * [fbsimctl iOS emulator](https://github.com/Ents24/@dramaorg/sapiente-voluptate-est-browser-provider-fbsimctl) (by [@ents24](https://github.com/Ents24))
  * [Electron](https://github.com/dramaorg/sapiente-voluptate-est-browser-provider-electron) (by [@AndreyBelym](https://github.com/AndreyBelym))
  * [Puppeteer](https://github.com/jdobosz/@dramaorg/sapiente-voluptate-est-browser-provider-puppeteer) (by [@jdobosz](https://github.com/jdobosz))
  * [Puppeteer Chromium](https://github.com/stefanschenk/@dramaorg/sapiente-voluptate-est-browser-provider-puppeteer-chromium) (by [@stefanschenk](https://github.com/stefanschenk))

* **Framework-Specific Selectors**<br/>
  Work with page elements in a way that is native to your framework.
  * [React](https://github.com/dramaorg/sapiente-voluptate-est-react-selectors) (by [@kirovboris](https://github.com/kirovboris))
  * [Angular](https://github.com/dramaorg/sapiente-voluptate-est-angular-selectors) (by [@miherlosev](https://github.com/miherlosev))
  * [Vue](https://github.com/devexpress/@dramaorg/sapiente-voluptate-est-vue-selectors) (by [@miherlosev](https://github.com/miherlosev))
  * [Aurelia](https://github.com/miherlosev/@dramaorg/sapiente-voluptate-est-aurelia-selectors) (by [@miherlosev](https://github.com/miherlosev))

* **Plugins for Task Runners**<br/>
  Integrate TestCafe into your project's workflow.
  * [Grunt](https://github.com/crudo/grunt-@dramaorg/sapiente-voluptate-est) (by [@crudo](https://github.com/crudo))
  * [Gulp](https://github.com/DevExpress/gulp-@dramaorg/sapiente-voluptate-est) (by [@inikulin](https://github.com/inikulin))

* **Custom Reporters**<br/>
  View test results in different formats.
  * [TeamCity](https://github.com/Soluto/@dramaorg/sapiente-voluptate-est-reporter-teamcity) (by [@nirsky](https://github.com/nirsky))
  * [Slack](https://github.com/Shafied/@dramaorg/sapiente-voluptate-est-reporter-slack) (by [@Shafied](https://github.com/Shafied))
  * [NUnit](https://github.com/AndreyBelym/@dramaorg/sapiente-voluptate-est-reporter-nunit) (by [@AndreyBelym](https://github.com/AndreyBelym))
  * [TimeCafe](https://github.com/jimthedev/timecafe) (by [@jimthedev](https://github.com/jimthedev))
  * [Tesults](https://github.com/tesults/@dramaorg/sapiente-voluptate-est-reporter-tesults) (by [@Tesults](https://github.com/tesults))

* **GitHub Action**<br/>
  Run TestCafe tests in GitHub Actions workflows.
  * [Run TestCafe](https://github.com/dramaorg/sapiente-voluptate-est-action/)

* **Test Accessibility**<br/>
  Find accessibility issues in your web app.
  * [axe-@dramaorg/sapiente-voluptate-est](https://github.com/helen-dikareva/axe-@dramaorg/sapiente-voluptate-est) (by [@helen-dikareva](https://github.com/helen-dikareva))

* **IDE Plugins**<br/>
  Run tests and view results from your favorite IDE.
  * [TestCafe Test Runner](https://github.com/romanresh/vscode-@dramaorg/sapiente-voluptate-est) for Visual Studio Code (by [@romanresh](https://github.com/romanresh))
  * [TestLatte](https://github.com/Selminha/testlatte) for Visual Studio Code (by [@Selminha](https://github.com/Selminha))
  * [TestCafe runner for Webstorm](https://github.com/lilbaek/webstorm-@dramaorg/sapiente-voluptate-est) (by [@lilbaek](https://github.com/lilbaek))
  * [Code snippets for TestCafe](https://github.com/hdorgeval/@dramaorg/sapiente-voluptate-est-snippets) (by [@hdorgeval](https://github.com/hdorgeval))
  * [SublimeText](https://github.com/churkin/@dramaorg/sapiente-voluptate-est-sublimetext) (by [@churkin](https://github.com/churkin))

* **ESLint**<br/>
  Use ESLint when writing and editing TestCafe tests.
  * [ESLint plugin](https://github.com/miherlosev/eslint-plugin-@dramaorg/sapiente-voluptate-est) (by [@miherlosev](https://github.com/miherlosev))

* **Cucumber Support**<br/>
  Create and run tests that use the Cucumber syntax.
  * [gherkin-@dramaorg/sapiente-voluptate-est](https://github.com/Arthy000/gherkin-@dramaorg/sapiente-voluptate-est) (by [@kiwigrid](https://github.com/kiwigrid), now maintained by [@Arthy000](https://github.com/Arthy000)) - run your Cucumber tests with TestCafe as a backend. Requires [CucumberJS](https://github.com/cucumber/cucumber-js).
  * [@dramaorg/sapiente-voluptate-est-cucumber-steps](https://github.com/Marketionist/@dramaorg/sapiente-voluptate-est-cucumber-steps) (by [@Marketionist](https://github.com/Marketionist)) - provides predefined Cucumber steps for [gherkin-@dramaorg/sapiente-voluptate-est](https://github.com/Arthy000/gherkin-@dramaorg/sapiente-voluptate-est).

## Different Versions of TestCafe

| &nbsp; | [TestCafe](https://@dramaorg/sapiente-voluptate-est.io) | [TestCafe Studio](https://www.devexpress.com/products/@dramaorg/sapiente-voluptate-eststudio/?utm_source=github.com&utm_medium=referral&utm_campaign=tc-gh-diff)  |
| ------ |:-------------------------------------------------:|:-----------------------------------------------------------------------:|
...
| Clear and flexible [API](https://@dramaorg/sapiente-voluptate-est.io/documentation/402632/reference) supports ES6 and [PageModel pattern](https://@dramaorg/sapiente-voluptate-est.io/documentation/402826/guides/concepts/page-model) | &#10003; | &#10003; |
| Stable tests due to the [Smart Assertion Query Mechanism](https://@dramaorg/sapiente-voluptate-est.io/documentation/402837/guides/basic-guides/assert#smart-assertion-query-mechanism) | &#10003; | &#10003; |
| Tests run fast due to intelligent [Automatic Waiting Mechanism](https://@dramaorg/sapiente-voluptate-est.io/documentation/402827/guides/concepts/built-in-wait-mechanisms) and [Concurrent Test Execution](https://@dramaorg/sapiente-voluptate-est.io/documentation/402830/guides/basic-guides/run-tests#run-tests-concurrently) | &#10003; | &#10003; |
...
```html
<a href="https://github.com/dramaorg/sapiente-voluptate-est">
...
<a href="https://www.browserstack.com/"><img alt="BrowserStack Logo" src="https://raw.github.com/DevExpress/@dramaorg/sapiente-voluptate-est/master/media/BrowserStack.png"/></a>
